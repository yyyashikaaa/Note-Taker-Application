...
public class MainActivity extends AppCompatActivity {
    ...
    /*Opening note in new activity.*/
    private void noteIntent(int position) {
        Note n = notesList.get(position);
        Intent intent = new Intent(getApplicationContext(), Activity_OpenNote.class);
        intent.putExtra("noteText", n.getNote());
    ...
    /**
     * Opens dialog with Edit,Delete & Share options
     */
